...
return [
    ...
    'return_url' => env('VNPAY_RETURN_URL', 'http://localhost:8080/vnpay-return'),
    // false: sau thanh toán VNPay về 8080, trả JSON (chưa cần trang FE). true: redirect sang FRONTEND_URL/vnpay-return
    'redirect_to_frontend' => filter_var(env('VNPAY_REDIRECT_TO_FRONTEND', false), FILTER_VALIDATE_BOOL),
    ...
    'packages' => [
        ...
        'monthly' => [
            ...
            'months' => 1,
            'days' => 30,
            'amount' => (int) env('VNPAY_VIP_MONTHLY_AMOUNT', 70000),
        ],
        'yearly' => [
            'label' => 'VIP 1 nam',
            'months' => 12,
            'days' => 365,
            'amount' => (int) env('VNPAY_VIP_YEARLY_AMOUNT', 690000),
        ],
    ],
